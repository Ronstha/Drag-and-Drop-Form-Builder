...
function DesignerComponent({ elementInstance }: { elementInstance: FormElementInstance }) {
    ...
    return (
        <div className="flex flex-col w-full gap-2">
            ...
            <Input type="number" readOnly placeholder={placeHolder}></Input>
...
function FormComponent({ elementInstance,submitValue,isInvalid,defaultValue}: { elementInstance: FormElementInstance,submitValue?:SubmitFunction,isInvalid?:boolean,defaultValue?:string}) {
    ...
    return (
        <div className="flex flex-col w-full gap-2">
            ...
            <Input type="number" className={cn(error&&'border-red-500')}  placeholder={placeHolder} onChange={e=>setValue(e.target.value)} onBlur={(e)=>{
